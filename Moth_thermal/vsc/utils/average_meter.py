...
class AverageMeter(object):
    ...
    def __init__(self, margin_threshold=mid_thres + 80, std=False, moving_window_size=10):
        ...
        self.thres = [mid_thres-60, mid_thres-40, mid_thres-20,
                      mid_thres, mid_thres+20, mid_thres+40, mid_thres+60]
    ...
    def update_moving(self, val):
        self.cells[1:self.moving_window_size] = self.cells[0:(
            self.moving_window_size-1)]
        self.cells[0] = val
    ...
    def update(self, val, n=1):
        ...
        self.cells[0] = val
        self.avgN = np.mean(
            self.cells[0:min(self.moving_window_size, self.count+1)])
